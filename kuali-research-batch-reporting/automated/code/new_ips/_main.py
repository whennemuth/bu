...
sql_scripts = ["new_ips_current.sql", "new_ips_prior.sql"]
csv_files = ["new_ips_current.csv", "new_ips_prior.csv"]

# Name of Excel file and tab name(s) when an Excel file is created from one or more CSV files.
excel_file = "new_ips_list.xlsx"
tab_names = ["New IPs Current Month", "New IPs Prior Month"]

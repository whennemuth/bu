...
sql_scripts = ["new_sponsor_activity.sql", "new_sponsor_reference.sql"]
csv_files = ["new_sponsor_activity.csv", "new_sponsor_reference.csv"]

# Name of Excel file and tab name(s) when an Excel file is created from one or more CSV files.
excel_file = "new_sponsor_activity.xlsx"
tab_names = ["New Sponsor Activity", "New Sponsor Reference"]

...
public class Utils {
	...
	public static void main(String[] args) {
		String s = "Version: 1903.0047: digest: sha256:55296493ab61dacaa7ecfc06cea9ef030918b89617df4684c2ab8d53b2ddc8ac size: 3665";
		
		System.out.println(s.split("\\s+")[1].replaceAll("[^\\.\\d]", "").trim());
	}
}
